...
def app():
    ...
    queries = {
        "Q1: Players from India": """
            SELECT full_name, playing_role 
            FROM players 
            WHERE country='India';
        """,

        "Q2: Top 10 ODI Run Scorers": """
            SELECT p.full_name, s.runs, s.batting_average
        ...
        "Q3: Cricket venues with capacity > 50,000": """
        ...
        "Q4: Count of matches won by each team": """
        ...
        "Q5: Count of players by playing role": """
        ...
        "Q6: Highest individual batting score per format": """
            SELECT playing_role AS format, COUNT(*) AS highest_runs
            FROM players
            GROUP BY playing_role;

        """,

        "Q7: Series started in 2024 with details": """
            SELECT series_name, host_country, match_type, start_date, total_matches
            FROM series
            WHERE strftime('%Y', start_date) = '2024';
        """,

        "Q8: Last 20 completed matches with details": """
        ...
        "Q10: Team performance home vs away": """
            SELECT t.team_name,
        ...
        "Q11: Players scoring 50 or more runs in an innings": """
        ...
        "Q12: Player performance in close matches (without matches won)": """
            SELECT p.full_name,
